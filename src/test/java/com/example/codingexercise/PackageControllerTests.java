...
class PackageControllerTests {
    ...
    void createPackage() {
        ...
        ProductPackage productPackage = packageRepository.getPackage(createdBody.getId());
    ...
    @Test
    void getPackage() {
        ProductPackage productPackage = packageRepository.createPackage("Test Name 2", "Test Desc 2", List.of("prod2"));
    ...
    @Test
    void listPackages() {
        ProductPackage productPackage1 = packageRepository.createPackage("Test Name 1", "Test Desc 1", List.of("prod1"));
        ProductPackage productPackage2 = packageRepository.createPackage("Test Name 2", "Test Desc 2", List.of("prod2"));
